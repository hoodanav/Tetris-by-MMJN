...
public class SaveView {
    ...
    public void saveBoard() {
        ...
        if (!(name.toLowerCase().endsWith(".ser"))) {this.saveFileErrorLabel.setText(saveFileNotSerError); return;}

        File f = new File(String.format("Assignment2/boards/%s", name));
        if (f.exists()) {this.saveFileErrorLabel.setText(saveFileExistsError); return;}
